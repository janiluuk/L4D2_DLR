...
- **Map & Ambient Music** – `!music` menu lets players enable round-start tracks and looping ambience. Server vars `start_music_enabled` and `ambient_music_enabled` control the defaults. Requires the [soundlib](https://github.com/Adrianilloo/soundlib) library.
